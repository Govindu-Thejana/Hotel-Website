...
<section className="container mx-auto py-12">
    ...
    <div class="w-full h-80 lg:w-3/4 lg:h-auto">
    ...
    <div
        ...
        <div class="flex flex-col p-12 md:px-16">
            <h2 class="text-2xl font-medium uppercase text-pcolor lg:text-4xl">our room & Suite choices</h2>
            <p class="mt-4">
            ...
            <div class="mt-8">
                <a href="#"
                    class="inline-block w-full text-center text-lg font-medium text-gray-100 bg-scolor border-solid border-2 border-gray-600 py-4 px-10 hover:bg-pcolor hover:shadow-md md:w-48">Read
                    More</a>
            </div>
        </div>
