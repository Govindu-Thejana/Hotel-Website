    ...
    const fetchRoomData = async () => {
      ...
      try {
        const response = await axios.get(
          `http://localhost:5555/rooms/${roomId}`
        );
    ...
    <div className="bg-gray-100">
      ...
      <section className="relative">
        ...
        <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
          <div className="text-center text-white">
            ...
            <p className="text-lg">
              Experience the best of comfort and luxury in the heart of the
              city.
            </p>
          </div>
        </div>
      ...
      <section className="text-left py-14 px-28 mx-5">
        ...
        <p className="text-gray-500 text-base md:text-lg leading-relaxed">
          Each room at Hotel Suneragira is bright and airy, offering all the
          essentials for a comfortable stay. Our focus extends beyond comfort to
          include sleek, contemporary design, complemented by rich, natural
          tones visible from your window or terrace{" "}
        </p>
      </section>
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="flex-grow">
            ...
            <div className="p-6 bg-white shadow-md rounded-lg">
              {/* Room Overview */}
              <div className="mb-6">
                <h2 className="text-2xl font-serif text-pcolor mb-3">
                  Overview
                </h2>
                <p className="text-gray-600 mb-5">{room.description}</p>
                <ul className="list-disc list-inside text-gray-600 space-y-2">
                  <li>
                    <strong>Occupancy:</strong> {room.capacity} persons
                  </li>
                  <li>
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                  {room.amenities.map((amenity, index) => (
                    <div
                      key={index}
                      className="flex items-center p-4 bg-acolor rounded-lg shadow-sm"
                    >
              ...
              <div>
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-2">
                  ...
                  <li>
                    <MdSmokeFree className="inline mr-2" /> 100% smoke-free
                    property
                  </li>
                  <li>
                    <MdOutlinePets className="inline mr-2" /> Pets allowed (dogs
                    only, max 1 per room, additional fees apply)
                  </li>
                  <li>
            ...
            <div className="w-full lg:w-96 bg-white p-6 rounded-xl shadow-lg self-start sticky top-6">
              ...
              <form className="space-y-4">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <button
                    type="submit"
                    className="bg-scolor text-white px-4 py-2 hover:bg-pcolor transition"
                  >
                    Book Now
                  </button>
                </div>
      ...
      <div className="py-10">
        <h2 className="text-left px-24 text-4xl font-serif text-gray-800 mb-10">
          Other Room Types
        </h2>
      ...
      <div className="py-20">
        <h2 className="text-left px-24 text-3xl font-serif text-gray-800 mb-10">
          CUSTOMIZE YOUR OWN PACKAGE HERE
        </h2>
        <StepCarousel />
        <></>
      </div>
